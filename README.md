# geolocation-go [![Docker](https://github.com/adavarski/REST-go-k8s-geolocation/actions/workflows/docker.yml/badge.svg)(https://github.com/adavarski/REST-go-k8s-geolocation/actions/workflows/docker.yml) 
